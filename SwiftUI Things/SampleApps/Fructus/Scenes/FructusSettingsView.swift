...
struct FructusSettingsView: View {
    
    @Environment(\.presentationMode) var presentationMode
    
    @AppStorage(Constants.AppStorage.fructusOnboarding) var isOnboarding: Bool = false
            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                        ...
                        SettingsRowView(name: "Developer", content: "Javier")
